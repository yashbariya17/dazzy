  ...
  return (
    <div>
      ...
      <section className="pt-8 bg-amber-100 ">
          ...
          {/* <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex ">
              {Array(3)
                ...
                .map((_, index) => (
                  <div
                    className="relative flex-[0_0_250px] h-[220px] mr-5 flex flex-col justify-center items-center bg-white rounded-tl-full rounded-tr-full"
                    key={index}
                  >
                    <img
                    ...
                    />
                    <button className="bg-red-600 text-white w-[100px] py-2 mt-4">Read More</button>
                  </div>
                ))}
            </div>
          </div> */}
            ...
            <div className="flex px-10">
              {Array(3)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="relative flex-[0_0_250px] h-[300px] mr-6 flex flex-col items-center bg-white rounded-tl-[150px] rounded-tr-[150px] shadow-md"
                  >
                    ...
                    <img
                      src={`/images/product${index + 1}.png`}
                      alt={`Slide ${index + 1}`}
                      className="absolute z-99 top-[-35px] mt-4 w-[175px] h-auto object-contain"
                    />
        ...
        <section className="h-[350px] overflow-hidden mr-10 ml-10 mt-20 relative bg-cover bg-center" style={{ backgroundImage: "url('/images/uperportion.png')" }}>
          <div className="flex justify-end h-full">
            <div className="bg-red-600 rounded-3xl h-[250px] w-[500px] flex flex-col gap-3 justify-center mr-20 mt-auto mb-auto">
              <h2 className="text-white text-3xl font-semibold text-center">ABOUT DAZZY</h2>
              <div className="flex gap-5 justify-center text-center mt-5">
                <div className="text-white font-bold text-2xl bg-black rounded-2xl h-[80px] w-[100px] pt-2.5">
                  150 + <p className="text-white text-xs font-light">Product Rating</p>
                </div>
                <div className="text-white font-bold text-2xl bg-black rounded-2xl h-[80px] w-[100px] pt-2.5">
                  36  <p className="text-white text-xs font-light">Brands</p>
                </div>
                <div className="text-white font-bold text-2xl bg-black rounded-2xl h-[80px] w-[100px] pt-2.5">
                  15+ <p className="text-white text-xs font-light">Export Destination</p>
                </div>
              </div>
              <p className="text-center mt-2 text-white" style={{ wordSpacing: "2px" }}>
                A Wide Range Of Confectionery Items
              </p>
            </div>
          </div>
        ...
        <section className="bg-[#111] text-white py-16 px-4 flex flex-col md:flex-row items-center justify-center relative mt-20">
          ...
          <div className="md:w-1/2 mt-10 md:mt-0 px-6 relative">
            ...
            <div className="bg-white text-gray-800 rounded-xl shadow-lg p-6 max-w-xl relative">
              ...
              <div className="absolute top-4 right-4 text-orange-500 text-3xl font-bold">”</div>
            </div>
        ...
        <footer className="bg-[#3b1e1d] text-[#f2e9df] py-10 relative mt-20">
          ...
          <div className="mt-16 flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-4">
            ...
            />
            <h2 className="text-3xl font-extrabold text-center md:text-right">footer details</h2>
          </div>
        </footer>
